 ...
 * in external_connect.js for SaBRO Cloud. Parses the room name and JSON Web
 * Token (JWT) from the URL and executes createConnectionExternally.
 *
 * NOTE: If you are using lib-jitsi-meet without SaBRO Cloud, you should use this
 * file as reference only because the implementation is SaBRO Cloud-specific.
 *
