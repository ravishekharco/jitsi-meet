...
/**
 * Restores a SaBRO Cloud config.js from {@code localStorage} if it was
 ...
 * @returns {?Object} The SaBRO Cloud config.js which was previously downloaded
...
export function setConfigFromURLParams(
    ...
    //     "interfaceConfig.APP_NAME": "SaBRO Cloud"
    // }
    // We want to have:
    // json = {
    //     config: {
