SaBRO Cloud - redux state persistence
====================================
SaBRO Cloud has a persistence layer that persists specific subtrees of the redux
...
When it's done, SaBRO Cloud will automatically persist these subtrees and
