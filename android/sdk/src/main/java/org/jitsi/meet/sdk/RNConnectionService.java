...
/**
 * The react-native side of SaBRO Cloud's {@link ConnectionService}. Exposes
 * the Java Script API.
 *
 * @author Pawel Domas
 */
...
class RNConnectionService extends ReactContextBaseJavaModule {
     ...
     *
     * @param callUUID - unique call identifier assigned by SaBRO Cloud to
     *        a conference call.
     * @param handle - a call handle which by default is SaBRO Cloud room's URL.
