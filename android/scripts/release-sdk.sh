...
echo "Releasing SaBRO Cloud SDK ${SDK_VERSION}"
...
# Now build and publish the SaBRO Cloud SDK and its dependencies
echo "Building and publishing the SaBRO Cloud SDK"
pushd ${THIS_DIR}/../
...
if [[ $DO_GIT_TAG == 1 ]]; then
    ...
    pushd ${MVN_REPO_PATH}
    git add -A .
    git commit -m "SaBRO Cloud SDK + dependencies: ${SDK_VERSION}"
    popd
